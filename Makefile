...
functional-tests-exitfirst:
	pytest --exitfirst --splits 6 --group $(PYTEST_GROUP) --store-durations --durations-path=.test_durations.$(PYTEST_GROUP) tests -vvv --cucumberjson=test-report.json --durations=0 --html=test-report.html

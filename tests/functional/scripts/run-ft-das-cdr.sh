...
python ${UMBRELLA_PATH}/tests/functional/scripts/rstuf-admin-ceremony.py '{
    ...
    "[cdr 1] Please enter delegated target role name": "default",
    "[cdr 1] Please enter days until expiry for 'default' role (1)": "7",
    "[cdr 1][path 1] Please enter path:": "*",
    "[select][cdr 1][path 1] continue/add new path/remove path": "add new path",
    "[cdr 1][path 2] Please enter path:" : "*/*",
    "[select][cdr 1][path 2] continue/add new path/remove path": "add new path",
    "[cdr 1][path 3] Please enter path:": "*/*/*",
    "[select][cdr 1][path 3] continue/add new path/remove path": "continue",
    "[select][cdr 1] Select signing": "Online Key (use the existing)",
    "[select][cdr 1] continue/add new delegation/add new delegation": "add new delegation",
    "[cdr 2] Please enter delegated target role name": "staging",
    "[cdr 2] Please enter days until expiry for 'default' role (1)": "30",
    "[cdr 2] Please enter path:": "staging/*",
    "[select][cdr 2] continue/add new path/remove path": "continue",
    "[select][cdr 2] Select signing": "Add Keys",
    "[cdr 2] Please enter 'staging' threshold": "2",
    "[select][cdr 2] [signer 1] Select a key type:": "Key PEM File",
    "[cdr 2] Please enter path to public key": "tests/files/key_storage/JJ.pub",
    "[cdr 2] Please enter key name": "JanisJoplin",
    "[select][cdr 2] Info: 1 key missing for threshold 2 (add/remove)": "add",
    "[select][cdr 2] [signer 2] Select a key type:": "Key PEM File",
    "[cdr 2] [signer 2] Please enter path to public key": "tests/files/key_storage/JH.pub",
    "[cdr 2] [signer 2] Please enter key name": "JimiHendrix",
    "[select][cdr 2] [signer 2] Info: Threshold 2 is met, more keys can be added (continue/add/remove)": "continue",
    "[select][cdr 2] [signer 2] Scontinue/add new delegation/add new delegation": "continue",
    "Please enter days until expiry for root role (365)": "365",
